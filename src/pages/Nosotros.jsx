...
const Nosotros = () => {
  const valores = [
    { title: "Compromiso", desc: "Cumplimos plazos y presupuestos con transparencia y dedicación total.", icon: CheckCircle, color: "text-sky-600" },
    { title: "Calidad", desc: "Materiales certificados y control de obra riguroso para resultados duraderos.", icon: Hammer, color: "text-amber-500" },
    { title: "Seguridad", desc: "Protocolos HSE (Salud, Seguridad y Ambiente) para cuidar a las personas y al entorno.", icon: ShieldCheck, color: "text-red-500" },
    { title: "Innovación", desc: "Métodos constructivos avanzados y digitalización (BIM) para mayor eficiencia.", icon: Lightbulb, color: "text-green-600" },
  ];
  ...
  const faqs = [
    { q: "¿Qué tipos de obras realizan?", a: "Ejecución y dirección de obras residenciales (viviendas unifamiliares, PH), comerciales (oficinas, locales) e industriales (naves); ampliaciones, refacciones y mantenimiento integral." },
    { q: "¿Trabajan con planos o proyectos propios?", a: "Podemos ejecutar sobre tu proyecto ya desarrollado o, si lo necesitas, podemos desarrollar el proyecto ejecutivo completo junto a nuestro estudio de arquitectura asociado." },
    { q: "¿Cómo presupuestan mi obra?", a: "Realizamos una visita técnica sin costo, relevamos en detalle tus necesidades y enviamos un presupuesto claro, detallado por ítems y con alcance, plazo y condiciones por escrito." },
  ];
  ...
  return (
    <main className="min-h-screen bg-gray-50 text-neutral-900 font-sans relative">
...
>
  <ArrowLeft className="h-4 w-4" />
      ...
      {/* HEADER (simulación espacio Navbar) */}
        ...
        <nav className="hidden sm:flex space-x-4">
          {['Inicio', 'Servicios', 'Obras', 'Contacto'].map((item) => (
            <a
              ...
              className="text-sm font-medium text-neutral-600 hover:text-sky-700 transition duration-150"
            >
              {item}
            </a>
          ))}
      ...
      <section className="relative h-[90vh] sm:h-[80vh] isolate overflow-hidden">
        <img
          ...
          onError={(e) => {
            ...
            e.currentTarget.src = "https://placehold.co/1920x1080/0e7490/f8fafc/png?text=IMAGEN+NO+ENCONTRADA";
          }}
        />
        <div className="absolute inset-0 -z-10 bg-sky-900/40" />
        <div className="mx-auto max-w-6xl px-4 pt-32 sm:pt-48 pb-16">
          <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight text-white">Sobre Nosotros</h1>
          <p className="mt-4 max-w-3xl text-xl text-white/90 font-light">
            En L & M Construcciones desarrollamos proyectos con foco en excelencia, seguridad y cumplimiento estricto.
            Acompañamos a cada cliente desde la planificación hasta la entrega final, garantizando una
            comunicación clara y un compromiso real.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            {/* Link interno → usar `to` */}
            <Link
              to="/contact"
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <h2 className="mt-2 text-4xl font-extrabold text-neutral-900">Líderes en ejecución de obras civiles</h2>
            <p className="mt-6 text-lg text-neutral-700 leading-relaxed">
              Somos una empresa constructora con base en Buenos Aires, dedicada a la ejecución y dirección de obras civiles.
              Integramos equipos técnicos con amplia experiencia en arquitectura, ingeniería y gestión de proyectos para
              entregar soluciones llave en mano de principio a fin.
            </p>
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-xl">
            ...
            <div className="mt-6 space-y-6 text-neutral-700">
              <p><span className="font-extrabold text-neutral-900">Misión:</span> construir de forma segura y eficiente, entregando proyectos de alto valor y durabilidad a nuestros clientes.</p>
              <p><span className="font-extrabold text-neutral-900">Visión:</span> ser la constructora referente en calidad, innovación y cumplimiento en la región de CABA y GBA.</p>
              <p><span className="font-extrabold text-neutral-900">Diferenciales:</span> acompañamiento integral y personalizado, documentación 100% clara, trazabilidad de avances en tiempo real y un trato cercano y honesto.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {valores.map((v) => {
              ...
              return (
                <div key={v.title} className="rounded-xl border border-neutral-200 bg-white p-6 shadow-lg transition duration-300 hover:shadow-sky-500/20 hover:border-sky-300">
        ...
        <div className="mx-auto max-w-6xl px-4 py-20">
          ...
          <div className="mt-12 grid items-start gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-neutral-200 bg-gray-50 p-6 text-center shadow-md">
              <Award className="mx-auto h-12 w-12 text-sky-700 mb-3" />
          ...
          {equipoCards.map((p) => (
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.currentTarget.onerror = null;
                  e.currentTarget.src = "https://placehold.co/400x400/94a3b8/0f172a/png?text=IMAGEN+NO+ENCONTRADA";
                }}
              />
              <div className="p-6">
      ...
      {/* CTA */}
      <section id="contacto-seccion" className="bg-sky-700">
