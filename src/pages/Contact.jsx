...
const Contact = () => {
  ...
  // 🔐 Variables EmailJS (vienen de tu archivo .env)
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      openModal(
        "error",
        "No pudimos enviar tu mensaje. Verificá tu conexión o probá nuevamente."
      );
    }
  };
    ...
    <section id="contacto" className="py-20 bg-gray-50 font-sans mt-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-500 max-w-2xl mx-auto">
            Iniciá tu proyecto hoy. Completá el formulario y te respondemos en
            menos de 24 horas.
          </p>
        </div>
