...
const projectPhotos = [
  ...
  { id: 35, src: img35, alt: 'Proyecto de construcción' },
{ id: 36, src: img36, alt: 'Proyecto de construcción' },
{ id: 37, src: img37, alt: 'Proyecto de construcción' },
{ id: 38, src: img38, alt: 'Proyecto de construcción' },
{ id: 39, src: img39, alt: 'Proyecto de construcción' },
{ id: 40, src: img40, alt: 'Proyecto de construcción' },
{ id: 41, src: img41, alt: 'Proyecto de construcción' },
{ id: 42, src: img42, alt: 'Proyecto de construcción' },
{ id: 43, src: img43, alt: 'Proyecto de construcción' },
{ id: 44, src: img44, alt: 'Proyecto de construcción' },
{ id: 45, src: img45, alt: 'Proyecto de construcción' },
{ id: 46, src: img46, alt: 'Proyecto de construcción' },
{ id: 47, src: img47, alt: 'Proyecto de construcción' },
{ id: 48, src: img48, alt: 'Proyecto de construcción' },
{ id: 49, src: img49, alt: 'Proyecto de construcción' },
{ id: 50, src: img50, alt: 'Proyecto de construcción' },
{ id: 51, src: img51, alt: 'Proyecto de construcción' },
{ id: 52, src: img52, alt: 'Proyecto de construcción' },
{ id: 53, src: img53, alt: 'Proyecto de construcción' },
];
